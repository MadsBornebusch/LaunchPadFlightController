...
#define UART_RX_BUFFER_SIZE2     128
#endif
#ifndef UART_TX_BUFFER_SIZE2
#define UART_TX_BUFFER_SIZE2     1024
#endif
#endif
...
extern void UARTprintf2(const char *pcString, ...);
extern void UARTvprintf2(const char *pcString, va_list vaArgP);
